CREATE TABLE "medicaid_inpatient_prevention_quality_indicators_pdi_for_pediatric_hospital_discharges_by_patient_zip_code_beginning_2011" (
	"discharge_year"	real,
	"zip_code"	text,
	"pdi_number"	text,
	"pdi_name"	text,
	"medicaid_pdi_hospitalizations"	real,
